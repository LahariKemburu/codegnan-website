...
const otherLocationsData = {
  ...
  courses: [
    { name: "Python full-stack course", link: "/python-full-stack-course" },
    { name: "Core Java training", link: "/core-java-training" },
    { name: "Java Full-stack training course", link: "/full-stack-java-training" },
...
export default function Python_training_in_banglore() {
  return (
    <div>
      <Training_template head={headData} middle={middleData} middle2={middle2Data} middle3={middle3Data} middle4={middle4Data} middle5={middle5Data} mentor={mentorsData} coursep={course_pricing} other={otherLocationsData} map_details={map_address}/>
    </div>
  );
}
